...
- [0008-pepper-identity-governance.md](0008-pepper-identity-governance.md) — `PEPPER_IDENTITY.md` governance: propose-then-approve with a two-section split (Epic 06)
- [0009-reflection-loop-design.md](0009-reflection-loop-design.md) — reflection loop daily-fixed cadence, local-only, additive event-triggered (Epic 06)
- [0010-codeact-sandbox.md](0010-codeact-sandbox.md) — CodeAct sandbox: containerized subprocess on the server (Epic 07)
...
The four foundational ADRs above (0001–0004) are tracked in Epic 00: Foundations & ADRs (issue #9). ADR-0005 is the first decision record produced under Epic 01: Trace Substrate (issue #17). ADR-0006 is the first decision record produced under Epic 04: Reflection Runtime (issue #36). ADR-0007 is the framework decision for Epic 05: DSPy/GEPA Optimization Loop (issue #43). ADR-0008 and ADR-0009 are decision records produced under Epic 06: Inner Life Moves (issue #49) — governance and reflection-loop design respectively. ADR-0010 is the sandbox-execution decision for CodeAct produced under Epic 07: Deferred — CodeAct & Subsystem Expansion (issue #58). ADR-0011 is the master ADR for Epic 08: Layer 3 — Mobile + Desktop Thin Clients on Tailscale-Accessible Server (issue #70); sibling ADRs 0012–0016 land under that epic.
