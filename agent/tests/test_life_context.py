...
def test_load_life_context_returns_string():
    content = load_life_context("data/life_context.md")
...
def test_get_life_context_sections_returns_dict():
    sections = get_life_context_sections("data/life_context.md")
...
def test_get_owner_name_reads_identity_section():
    assert get_owner_name("data/life_context.md") == "Jack Chan"
...
def test_build_system_prompt_soul_chars_logged(caplog):
    ...
    with caplog.at_level(logging.DEBUG):
        build_system_prompt("data/life_context.md")
